...
<template>
    <div class="md:flex justify-center items-center pt-4 md:pt-0">
        <img class="w-44" src="/imgs/crypto_acceptable.png" />
        <div class="flex items-center justify-start md:pl-2 pt-4 md:pt-0">
            <img class="w-8" src="/imgs/18.png" />
