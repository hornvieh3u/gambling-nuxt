<script setup lang="ts">
    ...
    watch(()=>store.state.gameData,()=>{
        if(isValidUrl(store.state.gameData)){
            $("#gameIframe").attr("src", store.state.gameData).show();
        }else{
            // html
            $("#gameIframe").attr("srcdoc", store.state.gameData).show();
        }
    });
